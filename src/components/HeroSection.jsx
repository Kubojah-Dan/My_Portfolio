  ...
  return (
    <section id="home" className="relative pt-32 pb-24 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 overflow-hidden">
      ...
      >
        ...
        <div className="absolute w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] md:w-[550px] md:h-[550px] border border-neon-cyan/5 rounded-full animate-[spin_30s_linear_infinite]" />
        <div className="absolute w-[280px] h-[280px] sm:w-[420px] sm:h-[420px] md:w-[500px] md:h-[500px] border border-dashed border-neon-cyan/20 rounded-full animate-[spin_20s_linear_reverse_infinite]" />

        {/* Glow Core */}
        <div className="absolute w-[220px] h-[220px] sm:w-[350px] sm:h-[350px] bg-neon-cyan/10 blur-[100px] rounded-full animate-pulse" />

        {/* Large Profile Circle */}
        <div className="relative w-[240px] h-[240px] sm:w-[320px] sm:h-[320px] md:w-[420px] md:h-[420px] rounded-full border-[6px] md:border-8 border-white/5 overflow-hidden bg-void-black shadow-[0_0_60px_-15px_rgba(0,240,255,0.4)] z-10">
          <img
